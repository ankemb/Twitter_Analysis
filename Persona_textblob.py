...
class SentimentAnalysis:
    ...
    def DownloadData(self):
        ...
        for tweet in self.tweets:
            ...
            polarities.append(analysis.sentiment.polarity)  # Append each tweet's polarity to a list
            polarity += analysis.sentiment.polarity  # adding up polarities to find the average later
            #print('analysis.sentiment.polarity:',analysis.sentiment.polarity)
            if (analysis.sentiment.polarity == 0):  # adding reaction of how Modi is reacting to find average later
                neutral += 1
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, searchTerm, noOfSearchTerms):
        ...
        plt.title('Persona on his recent ' + str(noOfSearchTerms) + ' Tweets.')
        plt.axis('equal')
        plt.tight_layout()
        plt.show()
